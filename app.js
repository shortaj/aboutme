...
function answers(correctAnswers) {
  ...
  var correctAnswersArray = ['Correct! I have a dog named Vincent.', 'You are right!', 'You are correct!', 'True! I am a Windows person.', 'Correct!'];
  ...
  var answersArray = [['YES', 'Y'], ['YES', 'Y'], ['TRUE', 'T'], ['NO', 'N'], ['NO', 'N']];
  ...
  function runQuestions() {
    ...
    for(var i = 0; i < questionsArray.length; i++) {
      ...
      correctAnswerFunction(userAnswer, i);
    }
  }
  //needs to run 5 times
  var correctAnswerFunction = function(userAnswer, i) {
    if(userAnswer.toUpperCase() === (answersArray[i][0] || answersArray[i][1])) {
      console.log(correctAnswers);
      alert(correctAnswersArray[i]);
      correctAnswers++;
    } else if (userAnswer.toUpperCase() !== answersArray[i][0] || answersArray[i][1]) {
      alert(incorrectAnswersArray[i]);
    } else {
      alert(invalidAnswer);
    }
  };
